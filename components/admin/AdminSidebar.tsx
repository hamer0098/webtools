...
import { LayoutDashboard, Wrench, NotebookPen, FileLock2, Mail, Bot, Archive, ShieldCheck, ScrollText } from 'lucide-react';
...
const ITEMS = [
  ...
  { href: '/admin/archive', label: '收藏箱', icon: Archive },
